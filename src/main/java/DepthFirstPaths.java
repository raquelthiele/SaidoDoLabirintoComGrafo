...
public class DepthFirstPaths {
    ...
    public static void main(String[] args) {
        ...
        StdOut.printf("O caminho da origem, vertice 0, até a saída, vertice 41, é: ");

        if (dfs.hasPathTo(START)) {
            for (int x : dfs.pathTo(START)) {
                StdOut.print("-" + x);
            }
            StdOut.println();
        }
            ...
            StdOut.printf("Não há caminho para a saída.");
        }
    }
